...
return [
    ...
    'two_factor_lost_fix_self'                   => 'If you run your own instance of Expenses manager, check the logs in <code>storage/logs</code> for instructions, or run <code>docker logs &lt;container_id&gt;</code> to see the instructions (refresh this page).',
    ...
    'mfa_backup_code'                            => 'You have used a backup code to login to Expenses manager. It can\'t be used again, so cross it from your list.',
    ...
    'need_more_help'                             => 'If you need more help using Expenses manager, please <a href="https://github.com/firefly-iii/firefly-iii/issues">open a ticket on Github</a>.',
    ...
    'cannot_redirect_to_account'                 => 'Expenses manager cannot redirect you to the correct page. Apologies.',
    ...
    'invalid_locale_settings'                    => 'Expenses manager is unable to format monetary amounts because your server is missing the required packages. There are <a href="https://github.com/firefly-iii/help/wiki/Missing-locale-packages">instructions how to do this</a>.',
    ...
    'login_page_title'                           => 'Login to Expenses manager',
    'register_page_title'                        => 'Register at Expenses manager',
    'forgot_pw_page_title'                       => 'Forgot your password for Expenses manager',
    'reset_pw_page_title'                        => 'Reset your password for Expenses manager',
    ...
    // API access
    'authorization_request'                      => 'Expenses manager v:version Authorization Request',
    ...
    'admin_update_check_explain'                 => 'Expenses manager can check for updates automatically. When you enable this setting, it will contact Github to see if a new version of Firefly III is available. When it is, you will get a notification. You can test this notification using the button on the right. Please indicate below if you want Firefly III to check for updates.',
    'check_for_updates_permission'               => 'Expenses manager can check for updates, but it needs your permission to do so. Please go to the <a href=":link">administration</a> to indicate if you would like this feature to be enabled.',
    ...
    'admin_update_check_now_explain'             => 'If you press the button, Expenses manager will see if your current version is the latest.',
    'check_for_updates_button'                   => 'Check now!',
    'update_new_version_alert'                   => 'A new version of Expenses manager is available. You are running :your_version, the latest version is :new_version which was released on :date.',
    ...
    'admin_update_channel_explain'               => 'Expenses manager has three update "channels" which determine how ahead of the curve you are in terms of features, enhancements and bugs. Use the "beta" channel if you\'re adventurous and the "alpha" when you like to live life dangerously.',
    ...
    'search'                                     => 'Search',
    'search_query'                               => 'Query',
    'search_found_transactions'                  => 'Expenses manager found :count transaction(s) in :time seconds.',
    'search_for_query'                           => 'Expenses manager is searching for transactions with all of these words in them: <span class="text-info">:query</span>',
    ...
    'search_box'                                 => 'Search',
    'search_box_intro'                           => 'Welcome to the search function of Expenses manager. Enter your search query in the box. Make sure you check out the help file because the search is pretty advanced.',
    ...
    'instructions_rule_from_bill'                => 'In order to match transactions to your new bill ":name", Expenses manager can create a rule that will automatically be checked against any transactions you store. Please verify the details below and store the rule to have Firefly III automatically match transactions to your new bill.',
    ...
    'pref_languages_help'                       => 'Expenses manager supports several languages. Which one do you prefer?',
    ...
    'currencies_intro'                          => 'Expenses manager supports various currencies which you can set and enable here.',
    ...
    'auto_match_on'                             => 'Automatically matched by Expenses manager',
    'auto_match_off'                            => 'Not automatically matched by Expenses manager',
    ...
    'account_missing_transaction'               => 'Account #:id (":name") cannot be viewed directly, but Expenses manager is missing redirect information.',
    ...
    'cash'                                      => 'cash',
    'cant_find_redirect_account'                => 'Expenses manager tried to redirect you but couldn\'t. Sorry about that. Back to the index.',
    ...
    'reconcile_has_more'                        => 'Your Expenses manager ledger has more money in it than your bank claims you should have. There are several options. Please choose what to do. Then, press "Confirm reconciliation".',
    'reconcile_has_less'                        => 'Your Expenses manager ledger has less money in it than your bank claims you should have. There are several options. Please choose what to do. Then, press "Confirm reconciliation".',
    'reconcile_is_equal'                        => 'Your Expenses manager ledger and your bank statements match. There is nothing to do. Please press "Confirm reconciliation" to confirm your input.',
    ...
    'savings_balance_text'                      => 'Expenses manager will automatically create a savings account for you. By default, there will be no money in your savings account, but if you tell Firefly III the balance it will be stored as such.',
